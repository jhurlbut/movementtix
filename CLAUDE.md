...
`src/movementtix/odyssey.py` (`python -m movementtix.odyssey`) watches **two venues** for The Odyssey in IMAX 70mm: night shows (≥5pm) with two adjacent available seats in row C or deeper.
